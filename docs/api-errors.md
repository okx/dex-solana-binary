...
| 400  | `INVALID_ARB_FEE_BPS`                 | `arbFeeBps` is greater than `10000`                                                                                         |
| 400  | `CONFLICTING_POSITIVE_SLIPPAGE_FEE_MODE` | `arbFeeBps` and `positiveSlippageBps` are both greater than `0`                                                         |
